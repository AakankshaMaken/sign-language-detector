...
while True:
    ...
    cv2.putText(frame, "z : "+str(count['z']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "1 : "+str(count['1']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "2 : "+str(count['2']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "3 : "+str(count['3']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    ...
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(directory+'1/'+str(count['z'])+'.png',frame)
    if interrupt & 0xFF == ord('2'):
        cv2.imwrite(directory+'2/'+str(count['z'])+'.png',frame)
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+'3/'+str(count['z'])+'.png',frame)
